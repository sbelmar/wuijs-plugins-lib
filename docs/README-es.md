...
| **Versión librería**  | `0.12.0` ([Registro de Cambios](https://github.com/wui-js/wuijs-plugins-lib/blob/main/docs/CHANGELOG-es.md)) |
...
| ---------------------------------------- |:-------:| ----------- |
| [WUIPluginThemes](#wuiplugin-themes)     | `0.11`  | Plugin para el manejo de temas prediseñados y modo claro y oscuro. |
...
```html
<link type="text/css" rel="stylesheet" href="./libreries/wui-js/plugins/themes/default/dark-0.11.css">
```
...
Requiere la implementación de la clase JS `WUIPluginThemes`, el archivo CSS fuente `wuiplugin-themes-0.11.css` y el archivo CSS de configuración del tema `wui-js/plugins/themes/{nombre}/settings-{versión}.css`.
...
| ---------------------- | ------------------------------------------------------- | ----------- |
| `-p`,<br>`--plugin`    | `../src/wui-js/plugins/themes/wuiplugin-themes-0.11.css` | Ruta al archivo CSS fuente del plugin themes. |
