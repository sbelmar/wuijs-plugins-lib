...
| **Library version**  | `0.9.0` ([Change Log](https://github.com/wui-js/wuijs-plugins-lib/blob/main/docs/CHANGELOG-en.md)) |
...
```html
<link rel="stylesheet" href="./libraries/wui-js/plugins/themes/default/light-0.8.css">
```
